...
CCD(**C**harge-**C**oupled **D**evice) 电荷耦合器件

CCD 的工作原理：在每个像素里**把光生电荷存成“电荷包”**，再用多相时钟把这些电荷包**一格一格耦合转移**到读出端进行输出。

下面即为生成电荷包的过程：

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-01.webp)

#### Deep depletion

对于右边的P-Si，栅加正压，于是把P-Si表面的空穴赶走，剩下受主离子(带负电)，形成耗尽区，能带弯曲。此时的<span className="katex">
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-02.webp)
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-03.webp)
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-04.webp)

- PN junction charge collector(PN 结电荷收集器)：感光元件，电子/空穴在 PN 结耗尽区电场作用下被分离并**累积成电荷**
- switch(开关)：选通某个像素是否要被读出
- Amplifier circuit(放大/缓冲电路)
- Shifter circuit(移位/扫描读出电路) + Signal out，读出电信号

以上了解即可

CMOS imagers can be integrated with signal processing and control circuitries to further reduce system costs. CMOS 图像传感器可以把**信号处理电路**和**控制电路**一起做在同一块芯片上（同一个 CMOS 工艺/同一颗 die 上），这样可以进一步**降低整个系统成本**。

However, The size constrain of the sensing circuits forces the CMOS imager to use very simple circuits.

但是，由于每个像素里能放的面积非常小（尺寸受限），用于感测的电路（像素内读出/放大/开关等）**不能做得太复杂**，所以 CMOS imager 往往只能用**很简单的像素电路**。

---

## Review：MOS Capacitor

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-05.webp)

下面开始直接偷Lecture 9的内容了<span>
...
> N-type MOS capacitor:  <span className="katex">
> <span className="katex-mathml">
> <math xmlns="http://www.w3.org/1998/Math/MathML">
> <semantics>
> <mrow>
...
> </span>
> 
> -polysilicon gate over P-body.
> 
> P-type MOS capacitor:  <span className="katex">
> <span className="katex-mathml">
> <math xmlns="http://www.w3.org/1998/Math/MathML">
> <semantics>
> <mrow>
...
> </span>
> 
> -polysilicon gate over N-body.

### 阈值电压的设计与调节

阈值电压是非常关键的一个参数，那么如何使阈值电压调节到我想要的方向呢？调节什么参数？

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-06.webp)
...
<span>
 ...
 通常设成“小的正值”，这样在0偏压的时候就不会形成反型层——不会导通了

**NMOS P-body 通常配** <span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-07.webp)
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-08.webp)
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-09.webp)

但是，栅如果是多晶硅，也会耗尽，则会带来<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-10.webp)
...
这一项则会导致在这张图中的Gate一侧出现能带弯曲，比如下面这个示意图，那么对于<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-11.webp)

从另外一个视角来看，多晶硅栅耗尽——耗尽层电势也是有影响的

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-12.webp)
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-13.webp)
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-14.webp)
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-15.webp)

对于N P两种型号的阈值电压：

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-16.webp)

---

## Review：MOS Capacitor Band Diagram

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-17.webp)

> What's the diagram like at <span className="katex">
> <span className="katex-mathml">
> <math xmlns="http://www.w3.org/1998/Math/MathML">
> <semantics>
> <mrow>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-18.webp)

---

## Review：MOS Capacitor C-V Curve

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-19.webp)

> What is the root cause of the low C in the HF CV branch?

高频下反型层需要的**少数载流子供给（生成/复合或从体区扩散）跟不上 AC**，小信号时 <span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
<span>
 ...
 变化 → 只能靠耗尽层宽度变化来响应 → 等效电容很小。

---

## Invention of the Field-Effect Transistor

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-20.webp)

## Modern Field-Effect Transistor(FET)

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-21.webp)

1. **An electric field is applied normal to the surface of the semiconductor (by applying a voltage to an overlying electrode), to modulate the conductance of the semiconductor**
→ 在半导体表面**法向**施加一个电场（通过对上方的电极施加电压来实现），以**调制**半导体的**电导**。
2. **Modulate drift current flowing between 2 contacts (“source” and “drain”) by varying the voltage on the “gate” electrode**
→ 通过改变“栅极（gate）”电极上的电压，来调制在两个接触端（“源极 source”和“漏极 drain”）之间流动的**漂移电流**。
...
<tbody>
  <tr style="border: none;">
    <td style="width: 53.0%; text-align: center; border: none; padding: 0.3em; margin: 0;">
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-22.webp" />
      </p>
    </td>
      ...
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-23.webp" />
      </p>
    </td>
  </tr>
</tbody>
...
<tbody>
  <tr style="border: none;">
    <td style="width: 44.0%; text-align: center; border: none; padding: 0.3em; margin: 0;">
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-24.webp" />
      </p>
    </td>
      ...
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-25.webp" />
      </p>
    </td>
  </tr>
</tbody>
...
(开启的电流大)与小的<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-26.webp)
...
控制下，PMOS和NMOS可以一个开一个关，实现互补，可以配合实现逻辑门电路，所以叫做Complementary MOS(CMOS)
...
<tbody>
  <tr style="border: none;">
    <td style="width: 46.0%; text-align: center; border: none; padding: 0.3em; margin: 0;">
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-27.webp" />
      </p>
    </td>
      ...
      <td style="width: 53.0%; text-align: center; border: none; padding: 0.3em; margin: 0;">
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-28.webp" />
      </p>
    </td>
  </tr>
</tbody>
...
> 我的评价是不如看模集(bushi)，主要是跟着推导一遍<span className="katex">
> <span className="katex-mathml">
> <math xmlns="http://www.w3.org/1998/Math/MathML">
> <semantics>
> <mrow>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-29.webp)

对于NMOS

1. 当<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
时，此时沟道还没形成反型层，栅下只有一片耗尽层(P-Si表面的空穴被排斥走，只剩下带负电的受主离子)
2. 当<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
后，栅下开始出现反型层，如果再加上<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
电压，就会导致反型层从源端到漏端逐渐变薄(因为Drain端的电压大，相当于削弱了靠近D侧的<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
电压小，反型层近似均匀时，<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
反型层的面电荷密度(<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
)，因为只有反型层的电荷可以移动，耗尽层电荷是固定的电离后的离子
- <span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
...
I_{DS}=WQ_{inv}\mu_{eff}E=WQ_{inv}\mu_{eff}(\frac{V_{DS}}{L})
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-30.webp)

沿沟道任意位置 <span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
进一步增大，夹断区拉长，此时有效的沟道长度就变成了<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
不可忽略，此时**由于**<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-31.webp)

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-32.webp)

由上面推导过程可得<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
I_{DS}=WQ_{inv}\mu_{eff}(\frac{V_{DS}}{L})
...
很小时，分布是均匀的，于是可以表达为<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
I_{DS}=(W/L)\mu_{eff}C_{oxe}(V_G-V_T)V_{DS}
...
> ##### 栅氧层电学厚度
> 
> ![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-33.webp)
> 
> 当<span className="katex">
> <span className="katex-mathml">
> <math xmlns="http://www.w3.org/1998/Math/MathML">
...
<span className="base">
<span className="strut" style="height:1.3339em;vertical-align:-0.4453em;">
...
<span className="base">
<span className="strut" style="height:1.4204em;vertical-align:-0.5481em;">
...
不仅要考虑到沿着沟道的水平方向的电场，还要考虑到垂直于沟道的电场强度，于是有下图

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-34.webp)
...
> **关键特征：表面粗糙散射会随法向电场增加而显著增强。**
> 原因是法向场越强，载流子被压得越贴近界面，越“感受到”界面凹凸；同时界面起伏导致的势能变化也更强 → 散射更严重 → <span className="katex">
> <span className="katex-mathml">
> <math xmlns="http://www.w3.org/1998/Math/MathML">
> <semantics>
> <mrow>
...
\mu_{eff}=\frac{\mu_0}{1+\theta(V_{G}-V_{T})}
...
<span className="base">
<span className="strut" style="height:1.2675em;vertical-align:-0.52em;">
...
<tbody>
  <tr style="border: none;">
    <td style="width: 51.0%; text-align: center; border: none; padding: 0.3em; margin: 0;">
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-35.webp" />
      </p>
    </td>
      ...
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-36.webp" />
      </p>
    </td>
  </tr>
</tbody>
...
时，电流在沟道当中主要是**载流子漂移**形成的，由于加了<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
，沟道中的电压在source和drain之间也是变化的，这里记作<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
表达式，由于现在多了这个<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
此时由于反型层刚刚出现<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
V_{ox}=\frac{-Q_{dep}}{C_{ox}}=\frac{\sqrt{2qN_A\varepsilon_{Si}(2\psi_B+V_{CB}(y))}}{C_{ox}}
...
<span className="base">
<span className="strut" style="height:1.7747em;vertical-align:-0.4451em;">
...
<span className="vlist-t,vlist-t2">
<span className="vlist-r">
<span className="vlist" style="height:1.3296em;">
<span style="top:-2.655em;">
<span className="pstrut" style="height:3em;">
...
<span className="vlist-t,vlist-t2">
<span className="vlist-r">
<span className="vlist" style="height:1.0369em;">
<span className="svg-align" style="top:-3.4286em;">
<span className="pstrut" style="height:3.4286em;">



</span>

<span className="mord,mtight" style="padding-left:1.19em;">
<span className="mord,mtight">
...
<span className="vlist-r">
<span className="vlist" style="height:0.3448em;">
<span style="top:-2.3567em;margin-left:-0.0359em;margin-right:0.0714em;">
<span className="pstrut" style="height:2.5em;">
...
<span className="hide-tail,mtight" style="min-width:0.853em;height:1.5429em;">
<svg xmlns="http://www.w3.org/2000/svg" width="400em" height="1.5429em" viewBox="0 0 400000 1080" preserveAspectRatio="xMinYMin slice">
<path d="M95,702
c-2.7,0,-7.17,-2.7,-13.5,-8c-5.8,-5.3,-9.5,-10,-9.5,-14
c0,-2,0.3,-3.3,1,-4c1.3,-2.7,23.83,-20.7,67.5,-54
c44.2,-33.3,65.8,-50.3,66.5,-51c1.3,-1.3,3,-2,5,-2c4.7,0,8.7,3.3,12,10
...
<span className="vlist-r">
<span className="vlist" style="height:0.4197em;">
<span>
...
V_{T}=V_{FB}+V_c(y)+2\psi_B+\frac{\sqrt{2qN_A\varepsilon_{Si}(2\psi_B+V_{CB}(y))}}{C_{ox}}
...
然后反型层电流可以写为<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
Q_{inv}(y)≈−C_{ox}[(V_G−V_C(y))−V_T(不含 V_C)(y)]
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-37.webp)
...
dV_c=I_{DS}\frac{dy}{q \mu_{eff}nWT_{inv}}=I_{DS}\frac{dy}{Q_{inv}\mu_{eff}WT_{inv}}
...
\int_0^LI_{DS}dy=-\int_{V_S}^{V_D}\mu_{eff}WQ_{inv}(V_C)dV_C
...
<span className="katex-html" ariaHidden="true">
<span className="base">
<span className="strut" style="height:2.5032em;vertical-align:-0.9119em;">
...
<span className="vlist-t,vlist-t2">
<span className="vlist-r">
<span className="vlist" style="height:1.5912em;">
...
<span className="base">
<span className="strut" style="height:2.6035em;vertical-align:-1.0123em;">
...
<span className="vlist-r">
<span className="vlist" style="height:1.0123em;">
<span>
...
I_{DS}=-\frac{W}{L}\mu_{eff}\int_{V_S}^{V_D}Q_{inv}(V_C)dV_C
...
，积分可得线性区的表达式（这里是把<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
当中，而且忽略了体效应，假设<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
跟模集这里类似的推导，只不过把<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-38.webp)

### 饱和电流的表达式

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-39.webp)

### Body effect | 体效应

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-40.webp)

### Problem with the "Square Law Theory"

但是我们平方率的假设存在问题

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-41.webp)

- 首先我们是假设栅上的电荷只由反型层来平衡，即<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
，但实际上还有耗尽层等等
- 然后我们忽略了耗尽层宽度/耗尽电荷沿沟道 y 方向的变化，即<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-42.webp)

这里即乘上了一个bulk-charge factor系数<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
<span className="katex-html" ariaHidden="true">
<span className="base">
<span className="strut" style="height:1.1591em;vertical-align:-0.345em;">
...
于是原来的饱和电流和跨导都会发生变化，变为原来的<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-43.webp)

## P-Channel MOSFET

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-44.webp)

关于PMOS

导通时的<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
由于Source是接VDD的，空穴从Source流向Drain，Drain上的电压要更低，于是
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/MicroelectronicDevices/Lecture10-45.webp)

修正的部分和NMOS一样的，注意绝对值比大小即可
