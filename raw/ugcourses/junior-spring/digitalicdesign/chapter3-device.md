...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-01.webp)
...
<tbody>
  <tr style="border: none;">
    <td style="width: 58.0%; text-align: center; border: none; padding: 0.3em; margin: 0;">
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-02.webp" />
      </p>
    </td>
      ...
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-03.webp" />
      </p>
    </td>
  </tr>
</tbody>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-04.webp)

如果考虑加入正向偏置电压<span className="katex">
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-05.webp)

电流特性如下图：

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-06.webp)

电容特性

**耗尽层电容：**

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-07.webp)
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-08.webp)

### 等效模型

左图(a)为理想二极管模型，使用公式<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
<span className="base">
<span className="strut" style="height:1.5052em;vertical-align:-0.25em;">
...
<span className="vlist-r">
<span className="vlist" style="height:1.2552em;">
<span style="top:-3.5178em;margin-right:0.05em;">
...
<span className="vlist-r">
<span className="vlist" style="height:0.5858em;">
<span>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-09.webp)

### SPICE二极管模型

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-10.webp)

## MOS Transistor | MOS管

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-11.webp)

### 简化开关模型

#### 简化模型

即关断的时候就是**开关断开，**导通的时候就是有一个**导通电阻**
...
<tbody>
  <tr style="border: none;">
    <td style="width: 49.0%; text-align: center; border: none; padding: 0.3em; margin: 0;">
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-12.webp" />
      </p>
    </td>
      ...
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-13.webp" />
      </p>
    </td>
  </tr>
</tbody>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-14.webp)

#### 速度饱和下的等效电阻模型

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-15.webp)
...
- 场景：NMOS 放电，<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
- 在这段放电过程中，通常有<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
<span>
  ...
  因此晶体管基本一直处于**速度饱和区**。
- 此时电流可近似写为<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
I_D(V)\approx I_{DSAT}(1+\lambda V)
...
<span style="top:-2.214em;margin-left:-0.2222em;margin-right:0.0714em;">
...
<span className="base">
<span className="strut" style="height:2.6502em;vertical-align:-1.0123em;">
...
<span className="vlist-t,vlist-t2">
<span className="vlist-r">
<span className="vlist" style="height:1.6379em;">
...
来计算，结果也是类似的，那么定性分析上趋势是相同的

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-16.webp)
...
<span>
 ...
 很大时，速度饱和主导，<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
<span>
 ...
 时，导通能力急剧变差，<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-17.webp)

### 阈值电压

#### 基本参数

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-18.webp)

#### Body Effect

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-19.webp)

### 线性区公式

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-20.webp)

### 长沟道线性区&饱和区公式

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-21.webp)

### SCE效应 —— Short Channel Effect
...
<tbody>
  <tr style="border: none;">
    <td style="width: 60.0%; text-align: center; border: none; padding: 0.3em; margin: 0;">
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-22.webp" />
      </p>
    </td>
      ...
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-23.webp" />
      </p>
    </td>
  </tr>
</tbody>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-24.webp)

1. 短沟道会更早饱和<span className="katex-display">
<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML" display="block">
<semantics>
...
2. 短沟道在速度饱和下更接近线性电压关系（**近似线性**）<span className="katex-display">
<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML" display="block">
<semantics>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-25.webp)

### <mark>MOSFET 统一手工分析模型</mark>

用**一套公式**覆盖 MOSFET 所有工作区（截止、线性、速度饱和、饱和（非速度饱和））

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-26.webp)

- 定义**过驱动电压**：<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
I_D = k'\frac{W}{L}\left(V_{GT}V_{min} - \frac{V_{min}^2}{2}\right)(1 + \lambda V_{DS})
...
**体效应**：源衬底存在电压差 <span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
<span className="vlist-t,vlist-t2">
<span className="vlist-r">
<span className="vlist" style="height:0.9839em;">
...
<span className="vlist-r">
<span className="vlist" style="height:0.2561em;">
<span>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-27.webp)

#### 亚阈值摆幅

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-28.webp)

亚阈值条件下，<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
I_D ∝ I_0 e^{\frac{qV_{GS}}{nkT}}, n = 1 + \frac{C_D}{C_{ox}}
...
<span className="base">
<span className="strut" style="height:1.3448em;vertical-align:-0.1944em;">
...
亚阈值摆幅就是电流<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
\Delta V_{GS} = S = n(\frac{kT}{q})ln(10)
...
<tbody>
  <tr style="border: none;">
    <td style="width: 49.0%; text-align: center; border: none; padding: 0.3em; margin: 0;">
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-29.webp" />
      </p>
    </td>
      ...
      <td style="width: 50.0%; text-align: center; border: none; padding: 0.3em; margin: 0;">
      <p>
        <img alt="img" src="https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-30.webp" />
      </p>
    </td>
  </tr>
</tbody>
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-31.webp)

#### Structure Capacitance ｜ 结构电容
...
：栅极与源/漏之间的电容,来源于栅极多晶硅在制造时物理上延伸并覆盖到源漏区上方，形成平行板电容, 即Overlap层

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-32.webp)

#### Channel Capacitance ｜ 沟道电容

栅氧化层下方感应出的沟道电荷层，栅极与沟道之间形成的电容，此种电容对于不同的MOS管状态是不同的，具体如下三种状态：

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-33.webp)

**截止、线性、饱和区，对应的电容值**

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-34.webp)

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-35.webp)

#### P-N Junction Capacitance ｜ 结电容（通常称为扩散电容）
...
来源于**源/漏掺杂区与衬底**形成的 **pn 结**，正常工作时该结**反偏**，形成耗尽层，等效为电容。其大小随反偏电压增大而减小（非线性）。

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-36.webp)

如图所示，由两部分电容组成：

1. 底板PN结电容<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
为单位面积的结电容
2. 侧壁PN结电容<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
C_{sw} = C_{jsw} \times \text{周长} = C_{jsw}(W + 2L_s)
...
> 注意：这里周长为什么不是<span className="katex">
> <span className="katex-mathml">
> <math xmlns="http://www.w3.org/1998/Math/MathML">
> <semantics>
> <mrow>
...
> </span>
> 
> ? 因为右侧这个沟道情况和衬底情况不太一样，<mark>
> 
> 本书中注释写到暂时忽略这部分电容
> 
> </mark>
> 
> ，对于近似分析来说无伤大雅，但是在SPICE模型中实际上是有另外一个电容参数来决定这个电容的
...
由两部分构成，第一部分是沟道电容，也就是gate、channel、source组成的<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
; 第二部分是Overlap层导致的，也就是**结构电容**<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
...
沟道电容gate、channel、body组成的

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-37.webp)

#### .25um工艺举例

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-38.webp)
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-39.webp)

#### MOS结构电阻

这部分直接沿用前面的结论，只是一个定性计算：

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-40.webp)
...
![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-41.webp)

对于源级、漏级的电阻可以用下面的式子表示：

![img](https://phenthu-1321233386.cos.ap-nanjing.myqcloud.com/img/DigitalICDesign/Chapter3-Device-42.webp)
...
为源/漏端的长度，见上图中的<span className="katex">
<span className="katex-mathml">
<math xmlns="http://www.w3.org/1998/Math/MathML">
<semantics>
<mrow>
